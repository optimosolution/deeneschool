...
<!--[if gt IE 8]><!--><html lang="en" class="no-js"><!--<![endif]-->
    ...
    <body class=" ">
            ...
            <header class="navbar navbar-inverse" role="banner">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a href="<?php echo Yii::app()->theme->baseUrl; ?>/" class="navbar-brand navbar-brand-img">
                            <img src="<?php echo Yii::app()->theme->baseUrl; ?>/img/logo.png" alt="MVP Ready">
                        </a>
                    </div> <!-- /.navbar-header -->
                    <nav class="collapse navbar-collapse" role="navigation">
                        <ul class="nav navbar-nav noticebar navbar-left">
                            <li class="dropdown">
                                <a href="<?php echo Yii::app()->theme->baseUrl; ?>/page-notifications.html" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <ul class="dropdown-menu noticebar-menu noticebar-hoverable" role="menu">
                                    ...
                                    <li>
                                        <a href="<?php echo Yii::app()->theme->baseUrl; ?>/page-notifications.html" class="noticebar-item">
                                    ...
                                    <li class="noticebar-menu-view-all">
                                        <a href="<?php echo Yii::app()->theme->baseUrl; ?>/page-notifications.html">View All Notifications</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu noticebar-menu noticebar-hoverable" role="menu">                
                                    ...
                                    <li>
                                        <a href="<?php echo Yii::app()->theme->baseUrl; ?>/page-notifications.html" class="noticebar-item">
                                            <span class="noticebar-item-image">
                                                <img src="<?php echo Yii::app()->theme->baseUrl; ?>/img/avatars/avatar-1-md.jpg" style="width: 50px" alt="">
                                            </span>
                                    ...
                                    <li>
                                        <a href="<?php echo Yii::app()->theme->baseUrl; ?>/page-notifications.html" class="noticebar-item">
                                            <span class="noticebar-item-image">
                                                <img src="<?php echo Yii::app()->theme->baseUrl; ?>/img/avatars/avatar-2-md.jpg" style="width: 50px" alt="">
                                            </span>
                                    ...
                                    <li class="noticebar-menu-view-all">
                                        <a href="<?php echo Yii::app()->theme->baseUrl; ?>/page-notifications.html">View All Messages</a>
                                    </li>
                                </ul>
                            </li>
                        ...
                        <ul class="nav navbar-nav navbar-right">    
                            ...
                            <li class="dropdown navbar-profile">
                                <a class="dropdown-toggle" data-toggle="dropdown" href="javascript:;">
                                    <img src="<?php echo Yii::app()->theme->baseUrl; ?>/img/avatars/avatar-1-xs.jpg" class="navbar-profile-avatar" alt="">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    ...
                                    <li>
                                        <a href="<?php echo Yii::app()->theme->baseUrl; ?>/page-profile.html">
                                    ...
                                    <li>
                                        <a href="<?php echo Yii::app()->theme->baseUrl; ?>/page-pricing.html">
                                    ...
                                    <li>
                                        <a href="<?php echo Yii::app()->theme->baseUrl; ?>/page-settings.html">
                                    ...
                                    <li>
                                        <a href="<?php echo Yii::app()->theme->baseUrl; ?>/account-login.html">
                    ...
                    <nav class="collapse mainnav-collapse" role="navigation">
                        ...
                        <ul class="mainnav-menu">
                            ...
                            <li class="dropdown active">
                                <a href="<?php echo Yii::app()->theme->baseUrl; ?>/index.html" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown">
                                    Dashboards
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li>
                                        <a href="<?php echo Yii::app()->theme->baseUrl; ?>/index.html">
                                    ...
                                    <li>
                                        <a href="<?php echo Yii::app()->theme->baseUrl; ?>/dashboard-2.html">
                                            <i class="fa fa-dashboard"></i> 
                                            &nbsp;&nbsp;Sidebar Dashboard
                                        </a>
                                    </li>
                                    ...
                                    <li>
                                        <a href="<?php echo Yii::app()->theme->baseUrl; ?>/dashboard-3.html">
                                            <i class="fa fa-dashboard"></i> 
                                            &nbsp;&nbsp;Reports Dashboard
                                        </a>
                                    </li>
                            ...
                            <li class="dropdown ">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li>
                                        <a href="<?php echo Yii::app()->theme->baseUrl; ?>/components-tabs.html">
                                            <i class="fa fa-bars"></i> 
                                            &nbsp;&nbsp;Tabs &amp; Accordions
                                        </a>
                                    </li>
                                    <li>
                                        <a href="<?php echo Yii::app()->theme->baseUrl; ?>/components-popups.html">
                                            <i class="fa fa-calendar-o"></i> 
                                            &nbsp;&nbsp;Popups &amp; Alerts
                                        </a>
                                    </li>
                                    <li>
                                        <a href="<?php echo Yii::app()->theme->baseUrl; ?>/components-validation.html">
                                            <i class="fa fa-check"></i> 
                                            &nbsp;&nbsp;Validation
                                        </a>
                                    </li>
                                    <li>
                                        <a href="<?php echo Yii::app()->theme->baseUrl; ?>/components-datatables.html">
                                            <i class="fa fa-table"></i> 
                                            &nbsp;&nbsp;Data Tables
                                        </a>
                                    </li>
                                    <li>
                                        <a href="<?php echo Yii::app()->theme->baseUrl; ?>/components-gallery.html">
                                            <i class="fa fa-picture-o"></i> 
                                            &nbsp;&nbsp;Gallery
                                        </a>
                                    </li>
                                    <li>
                                        <a href="<?php echo Yii::app()->theme->baseUrl; ?>/components-charts.html">
                            ...
                            <li class="dropdown ">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    ...
                                    <li>
                                        <a href="<?php echo Yii::app()->theme->baseUrl; ?>/page-faq.html">
                            ...
                            <li class="dropdown ">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li>
                                        <a href="<?php echo Yii::app()->theme->baseUrl; ?>/page-notifications.html">
                                            <i class="fa fa-bell"></i> 
                                            &nbsp;&nbsp;Notifications
                                        </a>
                                    </li>			
                                    <li>
                                        <a href="<?php echo Yii::app()->theme->baseUrl; ?>/extras-icons.html">
                                    ...
                                    <li class="dropdown-submenu">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a href="<?php echo Yii::app()->theme->baseUrl; ?>/page-404.html">
                                                    <i class="fa fa-ban"></i> 
                                                    &nbsp;&nbsp;404 Error
                                                </a>
                                            </li>
                                            <li>
                                                <a href="<?php echo Yii::app()->theme->baseUrl; ?>/page-500.html">
                                                    <i class="fa fa-ban"></i> 
                                                    &nbsp;&nbsp;500 Error
                                                </a>
                                            </li>
                                    ...
                                    <li class="dropdown-submenu">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li>
                                                <a href="<?php echo Yii::app()->theme->baseUrl; ?>/account-login-social.html">
                                                    <i class="fa fa-unlock"></i> 
                                                    &nbsp;&nbsp;Login Social
                                                </a>
                                            </li>
                                            <li>
                                                <a href="<?php echo Yii::app()->theme->baseUrl; ?>/account-signup.html">
                                                    <i class="fa fa-star"></i> 
                                                    &nbsp;&nbsp;Signup
                                                </a>
                                            </li>
                                            <li>
                                                <a href="<?php echo Yii::app()->theme->baseUrl; ?>/account-forgot.html">
                                                    <i class="fa fa-envelope"></i> 
                                                    &nbsp;&nbsp;Forgot Password
                                                </a>
                                            </li>
        ...
        <footer class="footer">
            <div class="container">
                <p class="pull-left">Copyright &copy; <?php echo Yii::app()->name; ?> <?php echo date('Y'); ?>. Designed and developed by <?php echo CHtml::link('Optimo Solution', 'http://www.optimosolution.com', array('target' => '_blank')); ?></p>
            </div>
        </footer>
        ...
        <!-- Plugin JS -->
        <script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/demos/flot/line.js"></script>
        <script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/demos/flot/pie.js"></script>
        <script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/demos/flot/auto.js"></script>
    </body>
</html>